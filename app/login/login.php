...
if (isset($_POST["enviar"])) {
    ...
    if ($usuario == ADMIN_USER && $password == ADMIN_PASS) {
        ...
        // Clientes
        $_SESSION['clientes'] = [
            ['id' => 1, 'nombre' => 'Amancio Ortega', 'usuario' => 'amancio', 'password' => '1234', 'alquileresMax' => 2, 'alquileres' => [2, 3]],
            ['id' => 2, 'nombre' => 'Pablo Picasso', 'usuario' => 'pablo', 'password' => 'abcd', 'alquileresMax' => 2, 'alquileres' => []]
        ];
